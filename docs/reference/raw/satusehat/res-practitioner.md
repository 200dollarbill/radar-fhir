...
id: res-practitioner
title: Practitioner
source_url: https://satusehat.kemkes.go.id/platform/docs/id/fhir/resources/practitioner/
group: satusehat
fhir_version: R4
fetched_at: '2026-09-11T13:20:47Z'
sha256: 847cb6a049ac1b9d8d87da7eab000e33504c7453d42c87108382ef697131600a
---
# Practitioner
...
Data dari praktisi kesehatan yang bersangkutan akan dipetakan dengan menggunakan standar FHIR `DomainResource` dengan tipe [Practitioner](https://simplifier.net/guide/SATUSEHAT-FHIR-R4-Implementation-Guide/Home/FHIRProfiles/Practitioner.page.md?version=current). Untuk informasi lebih lanjut dapat dilihat pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas))
