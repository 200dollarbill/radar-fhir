...
id: res-organization
title: Organization
source_url: https://satusehat.kemkes.go.id/platform/docs/id/fhir/resources/organization/
group: satusehat
fhir_version: R4
fetched_at: '2026-09-11T13:20:49Z'
sha256: ea82e0dfd7ad0f828642bccfa75d3802c68eab239761680a502212696e9aaeae
---
# Organization

Contoh Struktur Organisasi

![contoh struktur organisasi](../../_images/contoh-struktur-organisasi.svg)
...
Berikut pemetaan nilai untuk [Organization](https://simplifier.net/guide/SATUSEHAT-FHIR-R4-Implementation-Guide/Home/FHIRProfiles/Organization.page.md?version=current) yang direpresentasikan dalam peta referensi *(path)* ke properti *(element id)* terkait, untuk konteks data organisasi fasilitas pelayanan kesehatan:
...
Berisi data tipe organisasi dengan tipe data `Coding`, yang nilainya mengacu pada data terminologi [OrganizationType](http://terminology.hl7.org/CodeSystem/organization-type). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi data penggunaan alamat organisasi dengan tipe data `code`, yang nilainya mengacu pada data terminologi [AddressUse](http://hl7.org/fhir/address-use). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).

### Organization.address[i].type

Berisi data jenis alamat organisasi dengan tipe data `code`, yang nilainya mengacu pada data terminologi [AddressType](http://hl7.org/fhir/address-type). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Di mana isi dari parameter `{organization-ihs-number}` adalah ID organisasi induk yang didapatkan dari master sarana indeks dan `{id-suborganisasi}` adalah ID suborganisasi yang didapatkan dari hasil *response*. Untuk informasi lebih lanjut dapat dilihat pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas))
...
Berisi data kode yang dapat digunakan untuk menunjukkan kontak tujuan dengan tipe data `Coding`, yang nilainya mengacu pada data terminologi [ContactEntityType](http://terminology.hl7.org/CodeSystem/contactentity-type). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi data penggunaan kontak dengan tipe data `code`, yang nilainya mengacu pada data terminologi [NameUse](http://hl7.org/fhir/name-use). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi informasi yang menyediakan akses ke layanan yang dioperasikan untuk organisasi dengan tipe data `Reference` yang nilainya mengacu pada [Kamus Data Kesehatan Indonesia](https://fhir.kemkes.go.id/r4/StructureDefinition/Endpoint).
