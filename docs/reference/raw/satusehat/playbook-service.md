---
id: playbook-service
title: Layanan SATUSEHAT
source_url: https://satusehat.kemkes.go.id/platform/docs/id/playbook/service/
group: satusehat
fhir_version: R4
fetched_at: '2026-09-11T13:20:26Z'
sha256: 25794bd640500192a3f0adb542a9c2b900cc7010cd512a2ceeb0571cb42d059c
---
# Layanan SATUSEHAT

## Layanan SATUSEHAT yang Tersedia
...
| Layanan | Deskripsi |
| --- | --- |
| Data Pokok Identitas Pasien (Master Patient Index (MPI)) | Klien akan dapat mengambil nomor SATUSEHAT pasien dengan memberikan nomor Nomor Induk Kependudukan (NIK) dan/atau beberapa parameter demografi lainnya. |
| Data Pokok Identitas Nakes (Master SDMK) | Klien akan dapat mengambil nomor praktisi kesehatan IHS dengan memberikan nomor NIK dan/atau beberapa parameter demografi lainnya. |
...
### Data Pasien (Master Patient Index (MPI))
...
### Data Tenaga Kesehatan [Nakes] (Master SDMK)
...
### Data Fasilitas Layanan Kesehatan [fasyankes] (Master Sarana Index (MSI))
...
Data-data ini disusun berdasarkan dari berbagai sumber seperti Sistem Informasi Sumber Daya Manusia Kesehatan (SISDMK), Sistem Informasi Rumah Sakit (SIRS), Sistem Informasi Manajemen Data Kefarmasian (SIMADA), dan lain-lain.
