...
id: res-location
title: Location
source_url: https://satusehat.kemkes.go.id/platform/docs/id/fhir/resources/location/
group: satusehat
fhir_version: R4
fetched_at: '2026-09-11T13:20:50Z'
sha256: b47deba6a1b40c6f8fbffb7afcfabc22220f5c50b3c479569eec04090d0eb7ed
---
# Location

Contoh Struktur Lokasi

![contoh struktur lokasi](../../_images/contoh-struktur-lokasi.svg)
...
Berikut pemetaan nilai untuk [Location](https://simplifier.net/guide/SATUSEHAT-FHIR-R4-Implementation-Guide/Home/FHIRProfiles/Location.page.md?version=current) yang direpresentasikan dalam peta referensi *(path)* ke properti *(element id)* terkait, untuk konteks data lokasi fasilitas pelayanan kesehatan:
...
Berisi data status lokasi dengan tipe data `code`, yang nilainya mengacu pada data terminologi [LocationStatus](http://hl7.org/fhir/location-status). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi data status operasional lokasi, terutama digunakan untuk bed/kamar dengan tipe data `Coding`, yang nilainya mengacu pada data terminologi [Hl7VSBedStatus](http://terminology.hl7.org/CodeSystem/v2-0116). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi data terkait apakah suatu lokasi merupakan lokasi spesifik (contoh: Ruang Operasi A, Kamar Rawat Inap 215, dll) atau kelompok/kelas lokasi (contoh: Ruang Operasi, Kamar Rawat Inap, dll) dengan tipe data `code`, yang nilainya mengacu pada data terminologi [LocationMode](http://hl7.org/fhir/location-mode). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi data tipe fungsi lokasi dengan tipe data `Coding`, terutama digunakan untuk informasi terkait lokasi kamar *(bed)*. Nilainya mengacu pada data terminologi [ServiceDeliveryLocationRoleType](http://terminology.hl7.org/CodeSystem/v3-RoleCode). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi data jenis kontak dengan tipe data `code`, yang nilainya mengacu pada data terminologi [ContactPointSystem](http://hl7.org/fhir/contact-point-system). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi data penggunaan kontak dengan tipe data `code`, yang nilainya mengacu pada data terminologi [ContactPointUse](http://hl7.org/fhir/contact-point-use). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi data penggunaan alamat dengan tipe data `code`, yang nilainya mengacu pada data terminologi [AddressUse](http://hl7.org/fhir/address-use). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi satu atau lebih data bertipe `Extension` yang digunakan untuk menyimpan kode wilayah administratif dari lokasi organisasi, pasien, atau entitas lain, yang nilai dan strukturnya mengacu pada extension tambahan dengan nama [AdministrativeCode](https://simplifier.net/guide/SATUSEHAT-FHIR-R4-Implementation-Guide/Home/Extensions/AdministrativeCode.page.md?version=current).
...
Berisi satu atau lebih daftar data mengenai informasi terkait tipe fisik lokasi dengan tipe data `Coding`, yang nilainya mengacu pada terminologi [LocationType](https://hl7.org/fhir/codesystem-location-physical-type.html). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi satu atau lebih data kode hari, dengan tipe data `code`, yang nilainya mengacu pada terminologi [DaysOfWeek](http://hl7.org/fhir/days-of-week). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
