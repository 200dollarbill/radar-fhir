...
id: res-procedure
title: Procedure
source_url: https://satusehat.kemkes.go.id/platform/docs/id/fhir/resources/procedure/
group: satusehat
fhir_version: R4
fetched_at: '2026-09-11T13:20:57Z'
sha256: cb481363876c43d4ea5857e59835cec78bc4538a51d877b7f7b3d0e115e1a6e9
---
# Procedure
...
Berikut pemetaan nilai untuk [Procedure](https://simplifier.net/guide/SATUSEHAT-FHIR-R4-Implementation-Guide/Home/FHIRProfiles/Procedure.page.md?version=current) yang direpresentasikan dalam peta referensi *(path)* ke properti *(element id)* terkait, untuk konteks pengiriman data tindakan/prosedur medis:
...
Berisi data dengan tipe data `code`, yang nilainya mengacu pada data terminologi [IdentifierUse](http://hl7.org/fhir/identifier-use). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi data yang menyatakan kondisi suatu prosedur yang umumnya dalam keadaan masih berlangsung atau telah selesai dengan tipe data `code`, yang nilainya mengacu pada data terminologi [EventStatus](http://hl7.org/fhir/event-status). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi satu atau lebih data status prosedur saat ini dengan tipe data `Coding`, yang nilainya mengacu pada data terminologi SNOMED CT [ProcedureNotPerformedReason(SNOMED-CT)](http://hl7.org/fhir/ValueSet/procedure-not-performed-reason). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi data kode tindakan kepada pasien dengan tipe data `Coding`, yang nilainya mengacu pada data terminologi [ICD-9 CM](https://www.cdc.gov/nchs/icd/icd9.htm). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Di mana isi dari parameter `{id-resource-Encounter}` adalah ID Encounter yang didapatkan dari server. Untuk informasi lebih lanjut dapat dilihat pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas))
...
Berisi satu atau lebih data yang membedakan jenis keterlibatan pelaku dalam prosedur. Misalnya, ahli bedah, ahli anestesi, dan ahli endoskopi dengan tipe data `Coding`, yang nilainya mengacu pada data terminologi ProcedurePerformerRoleCodes [SNOMED CT](http://snomed.info/sct). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Di mana isi dari parameter `{practitioner-ihs-number}` adalah ID Nakes yang didapatkan dari master Nakes indeks. Untuk informasi lebih lanjut dapat dilihat pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas))
...
Di mana isi dari parameter `{organization-ihs-number}` adalah ID organisasi induk yang didapatkan dari master sarana indeks. Untuk informasi lebih lanjut dapat dilihat pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas))
...
Berisi data kode tindak lanjut prosedur dengan tipe data `Coding` yang nilainya mengacu pada data terminologi SNOMED CT [ProcedureFollowUpCodes(SNOMEDCT)](http://hl7.org/fhir/ValueSet/procedure-followup). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi data yang berkaitan dengan item yang digunakan dalam melakukan suatu prosedur engan tipe data `Coding` yang nilainya mengacu pada data terminologi [FHIRDeviceTypes](http://hl7.org/fhir/ValueSet/device-kind). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
