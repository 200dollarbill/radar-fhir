...
id: res-condition
title: Condition
source_url: https://satusehat.kemkes.go.id/platform/docs/id/fhir/resources/condition/
group: satusehat
fhir_version: R4
fetched_at: '2026-09-11T13:20:56Z'
sha256: 9c4df53de243d2f12502d879543559ab118df5a5f490bf2cbe1cecc9825171a1
---
# Condition
...
Berikut pemetaan nilai untuk [Condition](https://simplifier.net/guide/SATUSEHAT-FHIR-R4-Implementation-Guide/Home/FHIRProfiles/Condition.page.md?version=current) yang direpresentasikan dalam peta referensi *(path)* ke properti *(element id)* terkait, untuk konteks pengiriman data diagnosis pasien:
...
Berisi satu atau lebih data kode status klinis dari kondisi pasien dengan tipe data `Coding`, yang nilainya mengacu pada data terminologi [ConditionClinicalStatusCodes](http://terminology.hl7.org/CodeSystem/condition-clinical). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi satu atau lebih data kode status verifikasi untuk mendukung status klinis suatu kondisi/ penyakit dengan tipe data `Coding`, yang nilainya mengacu pada data terminologi [ConditionVerificationStatus](http://terminology.hl7.org/CodeSystem/condition-ver-status). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi satu atau lebih data kode kategori kondisi apakah problem atau keluhan yang dirasakan pasien (diagnosis pasien) dengan tipe data `Coding`, yang nilainya mengacu pada data terminologi [ConditionCategoryCodes](http://terminology.hl7.org/CodeSystem/condition-category). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi satu atau lebih data penilaian subjektif dari tingkat keparahan kondisi yang dievaluasi oleh dokter dengan tipe data `Coding`, yang nilainya mengacu pada data terminologi [SNOMED CT](https://hl7.org/FHIR/codesystem-snomedct.html). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi satu atau lebih data lokasi anatomis di mana kondisi/keluhan/diagnosis ini terjadi (bila relevan) dengan tipe data `Coding`, yang nilainya mengacu pada data terminologi [SNOMED CT](http://snomed.info/sct). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Di mana isi dari parameter {id-resource-Encounter} adalah ID *resource* `Encounter` yang didapatkan dari server. Untuk informasi lebih lanjut dapat dilihat pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas))
...
Berisi data dengan tipe data `CodeableConcept`, yang nilainya mengacu pada data terminologi [SNOMED CT](http://snomed.info/sct). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi satu atau lebih data bukti pendukung yang menjadi dasar status verifikasi penyakit dengan tipe data `CodeableConcept`, yang nilainya mengacu pada data terminologi [SNOMED CT](http://snomed.info/sct). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
