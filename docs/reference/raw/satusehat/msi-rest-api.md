...
id: msi-rest-api
title: MSI REST API
source_url: https://satusehat.kemkes.go.id/platform/docs/id/master-data/master-sarana-index/rest-api-msi/
group: satusehat
fhir_version: R4
fetched_at: '2026-09-11T13:21:56Z'
sha256: 8b21409e0a50852d749b8e79fccf188e558dad352ab1a61c94b28432d2033e12
---
# ReST API
...
|  |  |
| --- | --- |
|  | Untuk melakukan beberapa *request* ke ReST API SATUSEHAT yang akan dijelaskan atau dicontohkan di bagian ini, **WAJIB** melakukan proses autentikasi terlebih dahulu.  Setiap *request* diperlukan sebuah nilai token bertipe `Bearer` yang akan dimasukkan pada *header* `Authorization: Bearer <access_token>`.  Nilai `<access_token>` didapatkan dari properti `access_token` dari hasil *response* yang secara detail dijelaskan di artikel terkait [**Akses Token**](#apis-token-msi). |

## 2. *Postman Collection*

Silakan mengunduh *Postman Collection* untuk melihat contoh/melakukan workshop secara mandiri pada website [*Postman Collection* MSI](https://s.kemkes.go.id/MasterDataAPI) melalui web *browser* Anda.
...
[Unduh](https://drive.google.com/u/0/uc?id=1BEnyJUzwwQsaSbsa_QMW76UwM4LK9MCN&export=download)
