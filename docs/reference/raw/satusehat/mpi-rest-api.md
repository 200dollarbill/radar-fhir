...
id: mpi-rest-api
title: MPI REST API
source_url: https://satusehat.kemkes.go.id/platform/docs/id/master-data/master-patient-index/rest-api-mpi/
group: satusehat
fhir_version: R4
fetched_at: '2026-09-11T13:21:52Z'
sha256: 9a097e439dee01b0a252fd3cb286b807550e43452e00642dcc9c90671acf7253
---
# ReST API
...
Pastikan sistem RME fasyankes telah terverifikasi di SATUSEHAT Platform (SSP) dan fasyankes sudah melakukan proses pemutakhiran data di aplikasi DFO/REGFASYANKES/RS ONLINE. Untuk informasi lebih lanjut dapat dilihat pada [Panduan Registrasi](../../../registration-guide/#user-guide-regis).
...
[Unduh](https://drive.google.com/u/0/uc?id=1rOTqAkTTiGGI69lyUuiRvG3Ea97yqUAn&export=download)
