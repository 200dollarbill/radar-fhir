---
id: res-related-person
title: RelatedPerson
source_url: https://satusehat.kemkes.go.id/platform/docs/id/fhir/resources/related-person/
group: satusehat
fhir_version: R4
fetched_at: '2026-09-11T13:20:59Z'
sha256: 4a0c4ad16d41e94e1821586bc55f1c0e74749f37b7c40ac2156fba88f7a202fd
---
# RelatedPerson

Pengiriman data informasi orang terkait dapat dikirimkan menggunakan *resource* `Observation`.

Berikut pemetaan nilai untuk [RelatedPerson](https://simplifier.net/guide/SATUSEHAT-FHIR-R4-Implementation-Guide/Home/FHIRProfiles/RelatedPerson.page.md?version=current) yang direpresentasikan dalam peta referensi *(path)* ke properti *(element id)* terkait, untuk konteks informasi orang terkait:
...
Berisi data dengan tipe data `code`, yang nilainya mengacu pada data terminologi [IdentifierUse](http://hl7.org/fhir/identifier-use).
...
Berisi data jenis kontak dengan tipe data `code`, yang nilainya mengacu pada data terminologi [ContactPointSystem](http://hl7.org/fhir/contact-point-system).
...
Berisi data penggunaan kontak dengan tipe data `code`, yang nilainya mengacu pada data terminologi [ContactPointUse](http://hl7.org/fhir/contact-point-use).
...
Berisi data alamat orang terkait dengan tipe data `code`, yang nilainya mengacu pada data terminologi [AddressUse](http://hl7.org/fhir/address-use).
