...
id: res-encounter
title: Encounter
source_url: https://satusehat.kemkes.go.id/platform/docs/id/fhir/resources/encounter/
group: satusehat
fhir_version: R4
fetched_at: '2026-09-11T13:20:52Z'
sha256: 9d9f7e52bf3bc4aff7021a61e526d51c2f770cb9808f7de49bd7ce6576964932
---
# Encounter
...
Berikut pemetaan nilai untuk [Encounter](https://simplifier.net/guide/SATUSEHAT-FHIR-R4-Implementation-Guide/Home/FHIRProfiles/Encounter.page.md?version=current) yang direpresentasikan dalam peta referensi *(path)* ke properti *(element id)* terkait, untuk konteks data kunjungan:
...
|  |  |
| --- | --- |
|  | Variabel/parameter/element FHIR bersifat **WAJIB** *(Mandatory)* atau **TIDAK** disesuaikan dengan Panduan Interoperabilitas berdasarkan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas) ) |
...
Berisi data dengan tipe data `code`, yang nilainya mengacu pada data terminologi [IdentifierUse](http://hl7.org/fhir/identifier-use). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi data status tahapan dari pertemuan pasien dengan tipe data `code`, yang nilainya mengacu pada data terminologi [EncounterStatus](http://hl7.org/fhir/encounter-status). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi satu atau lebih data penyimpanan riwayat status dari kunjungan pasien dengan tipe data `code`. Terdapat 3 status yang wajib dikirimkan datanya yaitu *arrived, In-progress,* dan *finished*, yang nilainya mengacu pada data terminologi [EncounterStatus](http://hl7.org/fhir/encounter-status). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi data penyimpanan riwayat klasifikasi dari kunjungan pasien dengan tipe data `Coding`. yang nilainya mengacu pada salah satu data terminologi dengan nama [ActEncounterCode](http://terminology.hl7.org/CodeSystem/v3-ActCode). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi satu atau lebih data tipe spesifik dari kunjungan dengan tipe data `Coding`, yang nilainya mengacu pada data terminologi [EncounterType](http://terminology.hl7.org/CodeSystem/encounter-type). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi data tipe spesifik dari layanan yang diberikan dengan tipe data `Coding`, yang nilainya mengacu pada data terminologi [ServiceType](http://terminology.hl7.org/CodeSystem/service-type). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi data indikasi urgensi dari kunjungan dengan tipe data `Coding`, yang nilainya mengacu pada salah satu data terminologi dengan nama [ActPriority](http://terminology.hl7.org/CodeSystem/v3-ActPriority). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Di mana isi dari parameter `{patient-ihs-number}` adalah ID Patient yang didapatkan dari master pasien indeks. Untuk informasi lebih lanjut dapat dilihat pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas))
...
Di mana isi dari parameter {id-resource-EpisodeOfCare} adalah ID EpisodeOfCare yang didapatkan dari server. Untuk informasi lebih lanjut dapat dilihat pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas))
...
Di mana isi dari parameter {id-resource-ServiceRequest} adalah ID ServiceRequest yang didapatkan dari server. Untuk informasi lebih lanjut dapat dilihat pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas))
...
Berisi satu atau lebih data partisipan pertemuan pasien dengan tipe data `Coding`, yang nilainya mengacu pada salah satu data terminologi dengan nama [ParticipantType](http://terminology.hl7.org/CodeSystem/v3-ParticipationType). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Di mana isi dari parameter `{practitioner-ihs-number}` adalah ID Nakes organisasi induk yang didapatkan dari master Nakes indeks. Untuk informasi lebih lanjut dapat dilihat pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas))
...
Berisi satu atau lebih data kode alasan terjadinya kunjungan dengan tipe data `Coding`, yang nilainya mengacu pada salah satu data terminologi dengan nama [EncounterReasonCodes](http://hl7.org/fhir/R4/valueset-encounter-reason.html). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Di mana isi dari parameter {id-condition} adalah ID Condition yang didapatkan dari hasil *response*. Untuk informasi lebih lanjut dapat dilihat pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas))
...
Di mana isi dari parameter {id-resource-Condition} adalah ID Condition yang didapatkan dari server. Untuk informasi lebih lanjut dapat dilihat pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas))
...
Jika ada lebih dari 1 kondisi, maka gunakan elemen `rank` untuk mengurutkan mana diagnosa yang lebih utama. Semakin kecil angkanya, maka semakin utama, dengan tipe data [`positiveInt`](https://www.hl7.org/fhir/datatypes.html#positiveInt).
...
Di mana isi dari parameter {id-account} adalah ID Account yang didapatkan dari hasil *response*. Untuk informasi lebih lanjut dapat dilihat pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas))

## Encounter.hospitalization.preAdmissionIdentifier

Berisi data pre-admisi dengan tipe data [`Identifier`](http://hl7.org/fhir/R4/datatypes.html#Identifier).
...
Di mana isi dari parameter {id-resource-Location} adalah ID Location yang didapatkan dari server. Untuk informasi lebih lanjut dapat dilihat pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)).
...
Berisi data asal di mana sebelum pasien dirawat/admisia dengan tipe data `Coding`, yang nilainya mengacu pada salah satu data terminologi dengan nama [AdmitSource](http://terminology.hl7.org/CodeSystem/admit-source). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi satu atau lebih data preferensi diet yang dilaporkan oleh pasien dengan tipe data `Coding`, yang nilainya mengacu pada salah satu data terminologi dengan nama [Diet](http://terminology.hl7.org/CodeSystem/diet). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi satu atau lebih data permintaan khusus yang dibuat untuk kunjungan rawat inap ini seperti penyediaan peralatan khusus dan lain-lain dengan tipe data `Coding`, yang nilainya mengacu pada salah satu data terminologi dengan nama [SpecialArrangements](http://terminology.hl7.org/CodeSystem/encounter-special-arrangements). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi satu atau lebih data kategori atau tipe lokasi setelah pasien dipulangkan dengan tipe data `Coding`, yang nilainya mengacu pada salah satu data terminologi dengan nama [DischargeDisposition](http://terminology.hl7.org/CodeSystem/discharge-disposition). Untuk informasi data terminologi apa yang digunakan dapat mengacu pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi tipe data `CodeableConcept` yang digunakan untuk mendefinisikan kelas perawatan yang sedang dijalani pasien seperti Kelas 1, Kelas 2, Kelas 3, Kelas VIP, dan Kelas VVIP. Nilai dan strukturnya mengacu pada extension tambahan dengan nama [`serviceClass`](https://simplifier.net/guide/SATUSEHAT-FHIR-R4-Implementation-Guide/Home/Extensions/ServiceClass.page.md?version=current).

## Encounter.location.extension:serviceClass.upgradeClassIndicator

Berisi tipe data `CodeableConcept` yang digunakan untuk menyimpan informasi Perubahan Kelas Perawatan seperti Kelas Tetap Perawatan, Kenaikan Kelas Perawatan, Penurunan Kelas Perawatan, dan Titip Kelas Perawatan. Nilai dan strukturnya mengacu pada extension tambahan dengan nama [`serviceClass`](https://simplifier.net/guide/SATUSEHAT-FHIR-R4-Implementation-Guide/Home/Extensions/ServiceClass.page.md?version=current).
...
Di mana isi dari parameter {id-encounter} adalah ID Encounter yang didapatkan dari hasil *response*. Untuk informasi lebih lanjut dapat dilihat pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)).
