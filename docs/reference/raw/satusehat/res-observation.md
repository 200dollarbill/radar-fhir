...
id: res-observation
title: Observation
source_url: https://satusehat.kemkes.go.id/platform/docs/id/fhir/resources/observation/
group: satusehat
fhir_version: R4
fetched_at: '2026-09-11T13:20:54Z'
sha256: 19f0218291b8ece3883f77ff7796f6bee3d37870cae8128fb7f7ba796c4d604e
---
# Observation

Pengiriman data hasil pemeriksaan pasien dapat dikirimkan menggunakan *resource* `Observation`.

Berikut pemetaan nilai untuk [Observation](https://simplifier.net/guide/SATUSEHAT-FHIR-R4-Implementation-Guide/Home/FHIRProfiles/Observation.page.md?version=current) yang direpresentasikan dalam peta referensi *(path)* ke properti *(element id)* terkait, untuk konteks pemeriksaan laboratorium:
...
Di mana isi dari parameter `{id-resource-Procedure}` adalah ID Procedure yang didapatkan dari server. Untuk informasi lebih lanjut dapat dilihat pada Panduan Interoperabilitas sesuai dengan *use case* masing-masing (klik [**di sini**](../../../interoperability/#panduan-interoperabilitas)).
...
Berisi data mengenai status dari hasil observasi dengan tipe data `code` yang nilainya mengacu pada data terminologi [ObservationStatus](http://hl7.org/fhir/observation-status). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi satu atau lebih data dengan tipe data `Coding`. Nilainya mengacu pada data terminologi [Observation Category Codes](http://terminology.hl7.org/CodeSystem/observation-category). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi satu atau lebih data dengan tipe data `Coding`. Nilainya mengacu pada data terminologi [LOINC Codes](http://loinc.org/). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi satu atau lebih data dengan tipe data `Coding`. Nilainya mengacu pada data terminologi [DataAbsentReason](http://terminology.hl7.org/CodeSystem/data-absent-reason). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi satu atau lebih data dengan tipe data `Coding`. Nilainya mengacu pada data terminologi [Observation Interpretation Codes](http://terminology.hl7.org/CodeSystem/v3-ObservationInterpretation) dan (<http://terminology.kemkes.go.id/CodeSystem/clinical-term>). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi satu atau lebih data dengan tipe data `Coding`. Nilainya mengacu pada [SNOMED CT Body Structures](http://snomed.info/sct). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi satu atau lebih data dengan tipe data `Coding`. Nilainya mengacu pada [ObservationMethods](http://snomed.info/sct). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
...
Berisi satu atau lebih data dengan tipe data `Coding`. Nilainya mengacu pada [Observation Reference Range Meaning Codes](http://terminology.hl7.org/CodeSystem/referencerange-meaning). Informasi data terminologi apa yang digunakan dapat mengacu pada Lampiran Terminologi sesuai dengan *use case* masing-masing (klik [**di sini**](../../../terminology/#lamp-terminologi)) dan Standar Terminologi (klik [**di sini**](../../../terminology/standar-terminologi/#standar-terminologi)).
